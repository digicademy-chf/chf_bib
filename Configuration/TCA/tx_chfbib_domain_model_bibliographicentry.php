...
return [
    'ctrl' => [
        ...
        'searchFields'             => 'type,last_checked,item_title,standalone_title,meeting_title,series_title,uuid,publication_date,revision_date,revision_number,editorial_note,import_origin,import',
        'enablecolumns'            => [
            'disabled' => 'hidden',
            'starttime' => 'starttime',
            'endtime' => 'endtime',
